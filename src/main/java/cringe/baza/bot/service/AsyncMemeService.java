...
public class AsyncMemeService {
    ...
    public void processAndSaveMemeAsync(long chatId, long userId, PhotoSize[] photo, String description, String visibilityContext, int messageIdToEdit) {
        try {
            ...
            bot.execute(new EditMessageText(chatId, messageIdToEdit, text)
