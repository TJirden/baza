...
class UpdateProcessorTest {
  ...
  @Mock private TelegramUserService userService;

  @Mock private TelegramBot bot;

  @Mock private AsyncMemeService asyncMemeService;

  @InjectMocks private UpdateProcessor updateProcessor;
  ...
  void processImageSave_Success() {
    ...
    verify(asyncMemeService)
        .processAndSaveMemeAsync(
            eq(100L), eq(200L), eq(photo), eq("Funny dog"), eq("PUBLIC"), eq(777));
  }
}
